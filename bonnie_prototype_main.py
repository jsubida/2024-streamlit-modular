...
def reviewData(testing):
    ...
    if st.session_state['scenario_selection'] == '0':
        ...
        st.chat_message("ai").write("Please have a look at the stories above. Use the 👍 and 👎  to leave a rating and short comment on each of the scenarios. Then pick the one that you like the most to continue. ")
